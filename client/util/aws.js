...
export function addPhoto(file) {
  ...
  // desabilita AWS:
  // return Promise.resolve('https://mern-starter-kls-upload-photo-bucket.s3.amazonaws.com/mern-starter-kls-upload-photo-bucket-album/min1.png');

  const e = createAlbum(albumName);
  if(e<0) return e;
